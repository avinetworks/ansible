...
from ansible_collections.vmware.nsx_alb.tests.unit.compat.mock import patch, MagicMock

from ansible.errors import AnsibleError
from ansible.plugins.loader import lookup_loader
from ansible_collections.vmware.nsx_alb.plugins.lookup import avi
...
def test_lookup_multiple_obj(dummy_credentials):
    avi_lookup = lookup_loader.get('vmware.nsx_alb.avi')
    avi_mock = MagicMock()
